...
class DragAndDrobPage {
    ...
    moveColumnaToColumnB() {
        ...
        cy.get('#column-a .header').should('contain', 'Header A');  // Sprawdzenie, że nagłówek A jest w #column-a
        cy.get('#column-b .header').should('contain', 'Header B');  // Sprawdzenie, że nagłówek B jest w #column-b
